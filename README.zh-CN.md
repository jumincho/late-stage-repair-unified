...
[![Verify](https://github.com/jumincho/late-stage-repair-unified/actions/workflows/verify.yml/badge.svg)](https://github.com/jumincho/late-stage-repair-unified/actions/workflows/verify.yml)
...
- **"只修最后一步"一致地胜过"从头重写"**——在数学与输出约束两个领域都如此。
- **两个领域几乎共享同一条决策规则**——按领域定制与单一共享规则之间的差距极小。
- 但**并非"单一通用规则永远最优"**,且模型越大,增益的绝对值越小。
